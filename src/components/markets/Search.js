    ...
    <div className=" grid gap-y-[50px]">
      ...
      <div className='relative overflow-hidden'>
        <div className='overflow-auto'>
          <table className="overflow-x-auto grid gap-y-7 text-right border-t min-w-[1290px]">
            <thead>
              <tr className="grid grid-flow-col justify-stretch text-[24px] pt-7 border-t px-6">
